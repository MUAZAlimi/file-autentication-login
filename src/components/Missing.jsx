...
const Missing = () => {
  return (
    ...
    <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '4rem'}}>
        ...
        <a href="https://snakegamexenzia.netlify.app/" target="_blank" className="btn" rel="noreferrer">
            Game Mode 
